# Bibeebiz - IT Technology & Software Website 🚀 **[LIVE](https://website-weathered-sky-6888.fly.dev/)**

A static website for Bibeebiz, showcasing IT technology and software services.

> **🌐 Live Demo:** [https://website-weathered-sky-6888.fly.dev/](https://website-weathered-sky-6888.fly.dev/)  
> **🚀 Hosted on:** Fly.io (Global CDN)  
...
- **Hosting**: Fly.io (Global CDN, Container-based deployment)
- **Container**: Docker + Nginx for static file serving
- **Deployment**: Automated via Fly.io CLI
...
The website is currently deployed and live on Fly.io with automatic global CDN distribution.

- **Live URL**: https://website-weathered-sky-6888.fly.dev/
- **App Name**: `website-weathered-sky-6888`
...
### Deployment Files
The following files are auto-generated by Fly.io and should be committed to version control:
- `fly.toml` - App configuration and settings
